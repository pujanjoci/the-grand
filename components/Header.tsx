      ...
      >
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <Link 
              href="/" 
              className={`text-6xl font-parfumerie font-bold transition-all duration-500 transform hover:scale-105 ${
                isScrolled 
            ...
            >
              The Grand
              <span className={`block h-0.5 transition-all duration-500 origin-left ${
                isScrolled 
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {navItems.map((item, index) => (
                <Link 
                  key={item.href}
                  href={item.href}
                  className={`relative transition-all duration-300 group py-2 font-medium ${
                    isScrolled 
            ...
            <nav className="flex flex-col space-y-3 pb-4">
              {navItems.map((item, index) => (
                <Link 
                  key={item.href}
                  href={item.href}
                  className={`hover:bg-white/50 px-4 py-3 rounded-lg transition-all duration-300 transform hover:translate-x-2 backdrop-blur-sm ${
                    isScrolled 
